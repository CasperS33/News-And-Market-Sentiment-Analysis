...
ax1.plot(combined_data['Date'], combined_data['Avg_sentiment_score'], label='Avg Sentiment Score (GME/Gamestop)', color=color)
...
fig.suptitle('Avg. Sentiment Score (GME/Gamestop) and GME Relative Change to SP500', fontsize=14)
fig.tight_layout()
plt.show()
